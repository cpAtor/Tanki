...
namespace FusionExamples.Tanknarok
{
	...
	public class Bullet : Projectile
	{
		...
		{
			void InitializeTargetMarker(Vector3 bulletVelocity, Bullet.BulletSettings bulletSettings);
			void Destroy();
		}
		...
		public override void PreSpawn(Vector3 ownervelocity)
		{
		...
		public override void Spawned()
		{
			...
			if(_targetVisuals!=null)
				_targetVisuals.InitializeTargetMarker(velocity, _bulletSettings);
		}
